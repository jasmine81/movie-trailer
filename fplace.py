...
<style>
    ...
    header{
        text-shadow : 3px2pxrgb(180, 67, 141);
        font-family : AppleChancery, cursive;
        font-style : oblique;
        font-weight : 500;
        color : rgb(26, 7, 82);
        height : 15px;
    ...
    img{
        border : 5px solidrgb(218, 110, 166);
        height : 400px;
        width : 400px;
        border-radius : 5%;
    }
...
main_page_content = '''<body>
        ...
        <div class="container">
            <div class="img1" onclick="changeVideo('kOAS3bmtSAM')">
                <img  src="https://encrypted-tbn0.gstatic.com/grid-items?q=tb"
                "n:ANd9GcQ"
                "kVuw6z5E3xuFeVXDcveZGHDFcoSp_EbfAutt4nFgvn596s1Vv" alt="Stat"
                "ue of Liberty">
                ...
                "q=tbn:ANd9GcTBblePFpfGNoAOKfRthU-tz6QUFLllhpC0KKRPuin0CRQI36u"
                "3" alt="Eiffel Tower">
                ...
                <div class="img4" onclick="changeVideo('nGavsnu9m4A')">
                    <img src="http://www.towerofpisa.org/wp-content/uploads/p"
                    "hoto-gallery/pisa-leaning-tower.jpg" alt="Leaning Tow"
                    "er of Pisa">
                <figcaption style="text-align: center; color: rgb(118,69,"
                "96);">Leaning Tower of Pisa</figcaption>
                </div>
                <div class="img5" onclick="changeVideo('G2FrANjg_OY')">
                <img src="https://s3.envato.com/files/236066482/20160214-"
                "BatterySpencer-8824-8mp.jpg" alt="Golden Gate Bridge">
                ...
                "a/a1/Sydney_Opera_House_Night.jpg" alt="Opera House">
                <figcaption>Opera House</figcaption>
                </div>
                <div class="modal fade" id="myVideo" tabindex="0" ro"
                "le="history" aria-labelledby="myModalLabel">
                 <div class="modal-dialog" role="history">
                    <div class="modal-content">
                        <div class="modal-body">
                            <iframe id="myframeY" width="570" hei"
                            "ght="375" src="" frameborder="0" allow"
                            "fullscreen></iframe>
                         </div>
